...
As can be seen from the confusion matrix this model is accurate. I have done experiment with other models but the accuracy was worse. Because the test data was around 99% accurate I expected almost of the submitted test cases to be correct (they 
were all correct)
